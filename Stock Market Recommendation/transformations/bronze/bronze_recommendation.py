...
@dp.table(
    name="stock_market.bronze.bronze_recommendation",
    spark_conf = {
...
def bronze_recommendation():
    ...
    df = spark.readStream.format("cloudfiles")\
        ...
        .option("cloudFiles.schemaLocation", "abfss://bronze@adfpracticestorage12.dfs.core.windows.net/recommendation/checkpoint")\
        .option("cloudFiles.useManagedFileEvents", True)\
        .option("schemaEvolutionMode","rescue")\
        .load("abfss://destination@adfpracticestorage12.dfs.core.windows.net/recommendation")
